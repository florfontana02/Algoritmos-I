...
// agregamos un test con un viaje desordenado para que cubra todas las lineas de ordenarViaje(v)

vector<viaje> fDesordenado = {{
                           medicion(1.5,puntoGps(2.5, 2.89996)),
                           medicion(1.9,puntoGps(2.5, 2.89998)),
                           medicion(1.7,puntoGps(2.5, 2.89997))},
                   {
...
TEST(flotaTotalTEST, AlgunosAdentroConViajeDesordenadp){
    EXPECT_EQ(flota(fDesordenado, 1.8,2.55),2);
}